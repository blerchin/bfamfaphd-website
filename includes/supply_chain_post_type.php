...
function supply_chain_post_type() {
	...
	$labels = array(
		...
		'menu_name'             => __( 'Supply Chains', 'text_domain' ),
	...
	$args = array(
		...
		'description'           => __( 'Supply Chain Item', 'text_domain' ),
		'labels'                => $labels,
...
add_action( 'init', 'supply_chain_post_type', 0 );
